                            ...
                            @foreach ($organisasis as $organisasi)
                                <div class="col-md-4 col-sm-6 pe-2 ps-2">
                                    <div class="card w-100 shadow-xss rounded-xxl overflow-hidden border-0 mb-3 pb-3">
                                        <div class="card-body position-relative h150 bg-image-cover bg-image-center" style="background-image: url(https://source.unsplash.com/1024x576/?islamic,mosque{{ $loop->iteration }});"></div>
                                        ...
                                        <div class="card-body d-flex align-items-center ps-4 pe-4 pt-0">
                                            ...
                                            <h4 class="font-xsssss text-center text-grey-500 fw-600 ms-3 me-3"><b class="text-grey-900 mb-1 font-xss fw-700 d-inline-block ls-3 text-dark">2.1k </b> Kegiatan</h4>
                                        ...
                                        <div class="card-body d-flex align-items-center justify-content-center ps-4 pe-4 pt-0">
                                            ...
                                            {{-- <a id="copy-button" onclick="copyToClipboard('Nilai yang akan disalin')" class="bg-current btn-round-lg ms-2 rounded-3 text-grey-700"><i class="feather-link font-md text-white"></i></a> --}}
                                            {{-- <button onclick="copyToClipboard('Teks yang ingin disalin')">Salin</button> --}}
                                            {{-- <form>
                                            ...
                                            @can('organisasi update')
                                                <a href="#" class="bg-warning btn-round-lg ms-2 rounded-3 text-grey-700"><i class="feather-edit font-md text-white"></i></a>
                                            @endcan
