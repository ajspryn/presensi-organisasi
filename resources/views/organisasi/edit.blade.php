                ...
                <div class="middle-wrap">
                    <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                        <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                            ...
                            <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Edit Organisasi</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" value="{{ $organisasi->nama }}" required autofocus>
                                        </div>
                                    </div>

                                    <div class="col-lg-12 mb-3">
                                        <label class="mont-font fw-600 font-xsss">Alamat</label>
                                        <textarea class="form-control mb-0 p-3 h100 lh-16" rows="5" spellcheck="true" name="alamat">{{ $organisasi->alamat }}</textarea>
                                    </div>

                                    <div class="col-lg-12 mb-3">
                                        <label class="mont-font fw-600 font-xsss">Deskripsi</label>
                                        <textarea class="form-control mb-0 p-3 h100 lh-16" rows="5" spellcheck="true" name="deskripsi">{{ $organisasi->deskripsi }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="logo_lama" value="{{ $organisasi->logo }}">
                                        </div>
                                    </div>
