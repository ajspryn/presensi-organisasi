                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="page-title">
                                    <h4 class="mont-font fw-600 font-md mb-lg-5 mb-4">Form Edit Role</h4>
                                                ...
                                                <div class="col-lg-3 mb-2">
                                                    <div class="form-check text-left mb-2">
                                                        <label class="pt--1 form-check-label fw-600 font-xsss text-grey-700" for="Check{{ $loop->iteration }}">
                                                            <input type="checkbox" class="form-check-input mt-2" id="Check{{ $loop->iteration }}" name="permissions[]" value="{{ $permission->name }}" @if ($role->hasPermissionTo($permission)) checked @endif>
                                                            {{ $permission->name }}
                                                        </label>
                                                    </div>
                                                </div>
