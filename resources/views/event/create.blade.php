                    ...
                    <div class="col-xl-12">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                ...
                                <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Tambah Event</h4>
                            </div>
                            <div class="ard-body h250 p-0 rounded-xxl overflow-hidden m-3">
                                <div class="card w-100 border-0 shadow-none p-4 rounded-xxl" style="background-color: #e5f6ff;">
                                    <div class="card-body d-flex p-0">
                                        ...
                                        <h4 class="text-primary font-xl fw-700">{{ $organisasi->nama }} <span class="fw-500 mt-0 d-block text-grey-500 font-xssss"></span></h4>
                                    </div>
                                </div>
                            </div>
